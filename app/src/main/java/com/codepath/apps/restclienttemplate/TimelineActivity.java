...
public class TimelineActivity extends AppCompatActivity {
    ...
    // Can find methods to override with Ctrl + o
    @Override
    ...
    // When ComposeActivity icon is selected
    @Override
    ...
    // Tweet written in ComposeActivity to be updated in feed


    @Override
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        if (requestCode == REQUEST_CODE && resultCode == RESULT_OK) {
            Log.i(TAG, "Adding new tweet to timeline");
